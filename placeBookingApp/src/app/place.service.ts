...
// ]
  constructor(private http:HttpClient) {}
      addPlace(title:string,
        ...
        return this.http
        .post<{name: string}>
        ("https://placebookingapp-ca9e3-default-rtdb.firebaseio.com/offered-places.json",  // .jons only present in firebase.
      {
        ...newPlace,
        id: null
      })
    ...
    fetchPlace() {
      return this.http
        .get<{ [key: string]: placeData }>(
          'https://placebookingapp-ca9e3-default-rtdb.firebaseio.com/offered-places.json'
        )
        .pipe(
          map(resData => {
            const places = [];
    ...
    getPlace(id: string) {
      return this.http
        .get<placeData>(
          `https://placebookingapp-ca9e3-default-rtdb.firebaseio.com/offered-places/${id}.json`
        )
        .pipe(
          map(placeData => {
            return new Place(
    ...
    return this.places.pipe(
      ...
      switchMap(places => {
        ...
        return this.http.put(
          `https://placebookingapp-ca9e3-default-rtdb.firebaseio.com/offered-places/${placeId}.json`,
